        ...
        with SetVerbosity(self.verbose):
            ...
            with self.graph.as_default():
                ...
                with tf.variable_scope("loss", reuse=False):
                    ...
                    # self.obs_labels = tf.placeholder(tf.float32, [None], name="obs_labels")
                ...
                # optimizer = tf.train.GradientDescentOptimizer(learning_rate=0.001, epsilon=1e-5)
...
class Runner(AbstractEnvRunner):
    ...
    def run(self):
        ...
        for _ in range(self.n_steps):
            actions, values, rewards_p, self.states, neglogpacs = self.model.step(self.obs, self.states, self.dones)
            print(rewards_p)
